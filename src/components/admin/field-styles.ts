...
export const labelClass =
  "font-mono text-xs tracking-[0.1em] text-paper-dim uppercase";
...
export const linkMutedClass =
  "border border-paper/20 px-3 py-1.5 font-mono text-xs tracking-[0.05em] text-paper-dim uppercase transition-colors hover:border-brass hover:text-brass";
